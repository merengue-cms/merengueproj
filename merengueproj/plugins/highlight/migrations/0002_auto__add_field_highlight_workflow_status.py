...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Highlight.workflow_status'
        db.add_column('highlight_highlight', 'workflow_status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workflow.State'], null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Highlight.workflow_status'
        db.delete_column('highlight_highlight', 'workflow_status_id')
    ...
    models = {
        ...
        'highlight.highlight': {
            'Meta': {'ordering': "('-weight',)", 'object_name': 'Highlight'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('stdimage.fields.StdImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'related_content': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.BaseContent']", 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '200', 'db_index': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'draft'", 'max_length': '20', 'db_index': 'True'}),
