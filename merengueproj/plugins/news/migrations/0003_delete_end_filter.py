...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        try:
            collection = orm.models['collection.collection'].objects.get(slug='news')
            collection.include_filters.filter(filter_field='expire_date', filter_operator='date_gt').delete()
        except orm.models['collection.collection'].DoesNotExist:
            pass
