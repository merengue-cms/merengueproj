...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MicroSite.exclude_places'
        db.add_column('microsite_microsite', 'exclude_places', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'MicroSite.exclude_places'
        db.delete_column('microsite_microsite', 'exclude_places')
