...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'CustomPortlet.link'
        db.alter_column('customportlet_customportlet', 'link', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):
        # Changing field 'CustomPortlet.link'
        db.alter_column('customportlet_customportlet', 'link', self.gf('django.db.models.fields.CharField')(max_length=200))
