...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StandingOutCategory.order'
        db.add_column('standingout_standingoutcategory', 'order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'StandingOutCategory.order'
        db.delete_column('standingout_standingoutcategory', 'order')
