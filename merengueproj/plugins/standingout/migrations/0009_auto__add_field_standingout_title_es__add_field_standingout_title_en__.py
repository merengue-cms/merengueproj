...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StandingOut.belongs_to_section'
        db.add_column('standingout_standingout', 'belongs_to_section', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['section.BaseSection'], null=True, blank=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'StandingOut.belongs_to_section'
        db.delete_column('standingout_standingout', 'belongs_to_section_id')
    ...
    models = {
        ...
        'standingout.standingout': {
            ...
            'belongs_to_section': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['section.BaseSection']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'standingout.standingoutcategory': {
            'Meta': {'ordering': "('order',)", 'object_name': 'StandingOutCategory'},
