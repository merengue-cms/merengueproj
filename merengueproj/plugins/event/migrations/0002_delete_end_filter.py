...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        collection = orm.models['collection.collection'].objects.get(slug='event')
        collection.include_filters.filter(filter_field='end', filter_operator='date_gt').delete()
    ...
    models = {
        ...
        'event.event': {
            'Meta': {'ordering': "('-publish_date',)", 'object_name': 'Event', '_ormbases': ['base.BaseContent']},
            'basecontent_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['base.BaseContent']", 'unique': 'True', 'primary_key': 'True'}),
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['event.Category']", 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        'collection.collectiondisplayfieldfilter': {
            ...
            'filter_params': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        },
        ...
        'collection.feedcollection': {
            'Meta': {'object_name': 'FeedCollection', '_ormbases': ['collection.Collection']},
        ...
        'collection.feeditem': {
            'Meta': {'object_name': 'FeedItem', '_ormbases': ['base.BaseContent']},
            'basecontent_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['base.BaseContent']", 'unique': 'True', 'primary_key': 'True'}),
