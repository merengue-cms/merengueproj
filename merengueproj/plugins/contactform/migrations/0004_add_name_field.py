...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactFormOpt.name'
        db.add_column('contactform_contactformopt', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ContactFormOpt.name'
        db.delete_column('contactform_contactformopt', 'name')
    ...
    models = {
        ...
        'contactform.contactform': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_sender_email_editable': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'redirect_to': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'redirect_to_with_params': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'contactform.contactformselectopt': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'option': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'choices'", 'to': "orm['contactform.ContactFormOpt']"}),
