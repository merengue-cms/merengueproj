...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContactForm.redirect_to_with_params'
        db.add_column('contactform_contactform', 'redirect_to_with_params', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ContactForm.redirect_to_with_params'
        db.delete_column('contactform_contactform', 'redirect_to_with_params')
