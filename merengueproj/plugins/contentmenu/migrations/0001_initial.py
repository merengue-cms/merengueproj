...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_table('contentmenu_contentgroup')

        # Removing M2M table for field contents on 'ContentGroup'
        db.delete_table('contentmenu_contentgroup_contents')
    ...
    models = {
        ...
        'contentmenu.contentgroup': {
            ...
            'contents': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['base.BaseContent']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
