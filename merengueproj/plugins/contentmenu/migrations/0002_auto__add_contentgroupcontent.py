...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('contentmenu_contentgroup_contents', 'contentmenu_contentgroupcontent')
        db.add_column('contentmenu_contentgroupcontent', 'order', self.gf('django.db.models.fields.IntegerField')(default=1))

    def backwards(self, orm):

        db.delete_column('contentmenu_contentgroupcontent', 'order')
        db.rename_table('contentmenu_contentgroupcontent', 'contentmenu_contentgroup_contents')
    ...
    models = {
        ...
        'base.basecontent': {
            ...
            'commentable': ('django.db.models.fields.CharField', [], {'default': "'disabled'", 'max_length': '20'}),
        ...
        'contentmenu.contentgroup': {
            'Meta': {'object_name': 'ContentGroup'},
            'contents': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['base.BaseContent']", 'through': "orm['contentmenu.ContentGroupContent']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        'contentmenu.contentgroupcontent': {
            'Meta': {'object_name': 'ContentGroupContent'},
            'content': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.BaseContent']"}),
            'contentgroup': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contentmenu.ContentGroup']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
