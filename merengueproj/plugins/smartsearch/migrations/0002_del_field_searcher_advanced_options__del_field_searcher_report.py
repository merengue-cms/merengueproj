...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Searcher.advanced_options'
        db.delete_column('smartsearch_searcher', 'advanced_options')

        # Deleting field 'Searcher.report_display_fields'
        db.delete_column('smartsearch_searcher', 'report_display_fields')

        # Deleting field 'Searcher.report_filter_fields'
        db.delete_column('smartsearch_searcher', 'report_filter_fields')

        # Adding field 'Report.options'
        db.add_column('smartsearch_searcher', 'options', self.gf('configfield.dbfields.JSONField')(null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        # Adding field 'Searcher.advanced_options'
        db.add_column('smartsearch_searcher', 'advanced_options', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Searcher.report_display_fields'
        db.add_column('smartsearch_searcher', 'report_display_fields', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Searcher.report_filter_fields'
        db.add_column('smartsearch_searcher', 'report_filter_fields', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Report.options'
        db.delete_column('smartsearch_searcher', 'options')
    ...
    models = {
        ...
        'collection.collection': {
            'Meta': {'ordering': "('position', 'name_en')", 'object_name': 'Collection', '_ormbases': ['base.BaseContent']},
