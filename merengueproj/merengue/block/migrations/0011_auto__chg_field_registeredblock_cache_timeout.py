...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'RegisteredBlock.cache_timeout'
        db.alter_column('block_registeredblock', 'cache_timeout', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Changing field 'RegisteredBlock.cache_timeout'
        db.alter_column('block_registeredblock', 'cache_timeout', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'block.registeredblock': {
            ...
            'cache_timeout': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
