...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RegisteredBlock.is_fixed'
        db.add_column('block_registeredblock', 'is_fixed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'RegisteredBlock.is_fixed'
        db.delete_column('block_registeredblock', 'is_fixed')
