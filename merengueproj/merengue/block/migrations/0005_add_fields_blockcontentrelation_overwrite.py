...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlockContentRelation.overwrite_if_place'
        db.add_column('block_blockcontentrelation', 'overwrite_if_place', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'BlockContentRelation.overwrite_allways'
        db.add_column('block_blockcontentrelation', 'overwrite_allways', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'BlockContentRelation.overwrite_if_place'
        db.delete_column('block_blockcontentrelation', 'overwrite_if_place')

        # Deleting field 'BlockContentRelation.overwrite_allways'
        db.delete_column('block_blockcontentrelation', 'overwrite_allways')
    ...
    models = {
        ...
        'block.blockcontentrelation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'overwrite_allways': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
