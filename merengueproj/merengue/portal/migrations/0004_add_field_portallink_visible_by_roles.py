...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field visible_by_roles on 'PortalLink'
        db.create_table('portal_portallink_visible_by_roles', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('portallink', models.ForeignKey(orm['portal.portallink'], null=False)),
            ('role', models.ForeignKey(orm['perms.role'], null=False))
        ))
        db.create_unique('portal_portallink_visible_by_roles', ['portallink_id', 'role_id'])

    def backwards(self, orm):
        # Removing M2M table for field visible_by_roles on 'PortalLink'
        db.delete_table('portal_portallink_visible_by_roles')
    ...
    models = {
        ...
        'base.basecontent': {
            ...
            'participants': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'contents_participated'", 'blank': 'True', 'null': 'True', 'to': "orm['auth.User']"}),
        ...
        'perms.permission': {
            ...
            'codename': ('django.db.models.fields.CharField', [], {'max_length': '100', 'unique': 'True'}),
            'content_types': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'content_types'", 'blank': 'True', 'null': 'True', 'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'portal.portallink': {
            'Meta': {'ordering': "('order',)", 'object_name': 'PortalLink'},
            'cached_url': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'category': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'content': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.BaseContent']", 'null': 'True', 'blank': 'True'}),
            'external_url': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('stdimage.fields.StdImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '200', 'db_index': 'True'}),
            'visible_by_roles': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'visible_links'", 'blank': 'True', 'null': 'True', 'to': "orm['perms.Role']"}),
        },
        'workflow.state': {
            'Meta': {'object_name': 'State'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'transitions': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'states'", 'blank': 'True', 'null': 'True', 'to': "orm['workflow.Transition']"}),
            'workflow': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'states'", 'to': "orm['workflow.Workflow']"}),
        },
        'workflow.transition': {
            'Meta': {'object_name': 'Transition'},
            'destination': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'destination_state'", 'blank': 'True', 'null': 'True', 'to': "orm['workflow.State']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'workflow.workflow': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'initial_state': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'workflow_state'", 'blank': 'True', 'null': 'True', 'to': "orm['workflow.State']"}),
