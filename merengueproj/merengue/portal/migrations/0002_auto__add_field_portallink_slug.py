...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PortalLink.slug'
        db.add_column('portal_portallink', 'slug', self.gf('django.db.models.fields.SlugField')(default='linkslug', max_length=200, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PortalLink.slug'
        db.delete_column('portal_portallink', 'slug')
