...
{% endfor %}{% endautoescape %}    };{% endblock %}
	...
	{{ module }}.layers.vector.addFeatures([admin_geom]);
      ...
      if (admin_geom.geometry.CLASS_NAME == "OpenLayers.Geometry.Point") {
          {{ module }}.map.setCenter(new OpenLayers.LonLat(admin_geom.geometry.x, admin_geom.geometry.y), {{ default_zoom }});
      } else {
