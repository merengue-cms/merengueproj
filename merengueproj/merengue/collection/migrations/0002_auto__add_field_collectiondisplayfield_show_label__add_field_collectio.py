...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CollectionDisplayField.show_label'
        db.add_column('collection_collectiondisplayfield', 'show_label', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Collection.show_main_image'
        db.add_column('collection_collection', 'show_main_image', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CollectionDisplayField.show_label'
        db.delete_column('collection_collectiondisplayfield', 'show_label')

        # Deleting field 'Collection.show_main_image'
        db.delete_column('collection_collection', 'show_main_image')
