...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CollectionDisplayFieldFilter'
        db.create_table('collection_collectiondisplayfieldfilter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('display_field', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['collection.CollectionDisplayField'])),
            ('filter_module', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('filter_params', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('filter_order', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('collection', ['CollectionDisplayFieldFilter'])


    def backwards(self, orm):
        
        # Deleting model 'CollectionDisplayFieldFilter'
        db.delete_table('collection_collectiondisplayfieldfilter')
