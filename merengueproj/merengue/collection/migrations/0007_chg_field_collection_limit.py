...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'Collection.limit'
        db.alter_column('collection_collection', 'limit', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):
        # Changing field 'Collection.limit'
        db.alter_column('collection_collection', 'limit', self.gf('django.db.models.fields.IntegerField')(null=True))
