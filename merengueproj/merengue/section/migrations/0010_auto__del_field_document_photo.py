...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Document.photo'
        db.delete_column('section_document', 'photo')


    def backwards(self, orm):
        
        # Adding field 'Document.photo'
        db.add_column('section_document', 'photo', self.gf('stdimage.fields.StdImageField')(max_length=100, null=True, blank=True), keep_default=False)
