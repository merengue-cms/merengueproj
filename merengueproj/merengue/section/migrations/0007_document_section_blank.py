...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SectionRelatedContent.order'
        # (to signature: django.db.models.fields.PositiveIntegerField(default=0))
        db.alter_column('section_basesection_related_content', 'order', orm['section.sectionrelatedcontent:order'])
        
        # Changing field 'DocumentSection.body_es'
    ...
    def backwards(self, orm):
        ...
        # Deleting unique_together for [slug] on BaseSection.
        db.delete_unique('section_basesection', ['slug'])
