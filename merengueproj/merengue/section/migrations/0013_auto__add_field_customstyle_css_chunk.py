...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomStyle.css_chunk'
        db.add_column('section_customstyle', 'css_chunk', self.gf('django.db.models.fields.TextField')(default='css'), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'CustomStyle.css_chunk'
        db.delete_column('section_customstyle', 'css_chunk')
