...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Document.permanent'
        db.delete_column('section_document', 'permanent')

    def backwards(self, orm):
        # Adding field 'Document.permanent'
        db.add_column('section_document', 'permanent', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
