...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Removing M2M table for field visible_by_roles on 'Menu'
        db.delete_table('section_menu_visible_by_roles')
    ...
    models = {
        ...
        'section.document': {
            'Meta': {'ordering': "('position', )", 'object_name': 'Document', '_ormbases': ['base.BaseContent']},
            'basecontent_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['base.BaseContent']", 'unique': 'True', 'primary_key': 'True'}),
        },
