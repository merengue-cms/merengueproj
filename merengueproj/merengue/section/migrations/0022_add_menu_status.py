...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('section_menu', 'status', self.gf('django.db.models.fields.CharField')(default='public', max_length=25), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Menu.status'
        db.delete_column('section_menu', 'status')
    ...
    models = {
        ...
        'base.basecontent': {
            ...
            'cached_plain_text_it': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '200', 'db_index': 'True'}),
            'name_es': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'name_fr': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'name_it': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            ...
            'plain_description_it': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'section.document': {
            'Meta': {'ordering': "('position', 'name_en')", 'object_name': 'Document', '_ormbases': ['base.BaseContent']},
            'basecontent_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['base.BaseContent']", 'unique': 'True', 'primary_key': 'True'})
        },
        'section.documentsection': {
            'Meta': {'ordering': "('position',)", 'object_name': 'DocumentSection'},
            'body_en': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'body_es': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'body_fr': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'body_it': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
        ...
        'section.menu': {
            ...
            'help_text_it': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
