...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'CustomStyle.css_chunk'
        db.alter_column('section_customstyle', 'css_chunk', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Changing field 'CustomStyle.css_chunk'
        db.alter_column('section_customstyle', 'css_chunk', self.gf('django.db.models.fields.TextField')())
