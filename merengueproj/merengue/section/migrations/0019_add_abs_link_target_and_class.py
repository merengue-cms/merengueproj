...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AbsoluteLink.target_blank'
        db.add_column('section_absolutelink', 'target_blank', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'AbsoluteLink.link_class'
        db.add_column('section_absolutelink', 'link_class', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'AbsoluteLink.target_blank'
        db.delete_column('section_absolutelink', 'target_blank')

        # Deleting field 'AbsoluteLink.link_class'
        db.delete_column('section_absolutelink', 'link_class')
    ...
    models = {
        ...
        'section.document': {
            'Meta': {'ordering': "('name_en',)", 'object_name': 'Document', '_ormbases': ['base.BaseContent']},
            'basecontent_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['base.BaseContent']", 'unique': 'True', 'primary_key': 'True'}),
