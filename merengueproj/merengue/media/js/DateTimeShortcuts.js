...
var DateTimeShortcuts = {
    ...
    addCalendar: function(inp) {
        ...
        cal_nav_prev.className = 'calendarnav-previous-month';
        var cal_nav_next = quickElement('a', cal_nav, '›', 'href', 'javascript:DateTimeShortcuts.drawNext('+num+');');
        cal_nav_next.className = 'calendarnav-next-month';

        var cal_nav_prev_year = quickElement('a', cal_nav, '«', 'href', 'javascript:DateTimeShortcuts.drawPrevYear('+num+');');
        cal_nav_prev_year.className = 'calendarnav-previous';
        var cal_nav_next_year = quickElement('a', cal_nav, '»', 'href', 'javascript:DateTimeShortcuts.drawNextYear('+num+');');
        cal_nav_next_year.className = 'calendarnav-next';
	...
	if (inp.value) {
        ...
        if(typeof MooTools == 'undefined') {
          ...
          $(window.document).addEvent('click', function() { DateTimeShortcuts.dismissCalendar(num); return true; });
        }
    },
