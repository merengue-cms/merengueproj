...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('perms_accessrequest', (
            ...
            ('request_notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('perms', ['AccessRequest'])

    def backwards(self, orm):

        # Deleting model 'AccessRequest'
        db.delete_table('perms_accessrequest')
