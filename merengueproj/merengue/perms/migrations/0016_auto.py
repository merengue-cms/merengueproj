...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field owners on 'AccessRequest'
        db.create_table('perms_accessrequest_owners', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('accessrequest', models.ForeignKey(orm['perms.accessrequest'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('perms_accessrequest_owners', ['accessrequest_id', 'user_id'])

    def backwards(self, orm):
        # Removing M2M table for field owners on 'AccessRequest'
        db.delete_table('perms_accessrequest_owners')
    ...
    models = {
        ...
        'perms.accessrequest': {
            ...
            'owners': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'access_review'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"}),
