...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ObjectPermission.content'
        db.alter_column('perms_objectpermission', 'content_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.BaseContent'], null=True, blank=True))


    def backwards(self, orm):

        # Changing field 'ObjectPermission.content'
        db.alter_column('perms_objectpermission', 'content_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.BaseContent']))
