...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccessRequest.permission'
        db.add_column('perms_accessrequest', 'permission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['perms.Permission'], null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'AccessRequest.permission'
        db.delete_column('perms_accessrequest', 'permission_id')
