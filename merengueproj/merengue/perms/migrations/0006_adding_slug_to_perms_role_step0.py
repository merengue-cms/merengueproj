...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Role.slug'
        db.add_column('perms_role', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=200, unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Role.slug'
        db.delete_column('perms_role', 'slug')
