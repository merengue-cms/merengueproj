...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Role.slug'
        db.alter_column('perms_role', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=200, unique=True))


    def backwards(self, orm):
        
        # Changing field 'Role.slug'
        db.alter_column('perms_role', 'slug', self.gf('django.db.models.fields.SlugField')(blank=True, unique=True, max_length=200, null=True))
