...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccessRequest.is_done'
        db.add_column('perms_accessrequest', 'is_done', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding M2M table for field roles on 'AccessRequest'
        db.create_table('perms_accessrequest_roles', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('accessrequest', models.ForeignKey(orm['perms.accessrequest'], null=False)),
            ('role', models.ForeignKey(orm['perms.role'], null=False))
        ))
        db.create_unique('perms_accessrequest_roles', ['accessrequest_id', 'role_id'])

    def backwards(self, orm):
        # Deleting field 'AccessRequest.state'
        db.delete_column('perms_accessrequest', 'state_id')

        # Deleting field 'AccessRequest.is_done'
        db.delete_column('perms_accessrequest', 'is_done')

        # Removing M2M table for field roles on 'AccessRequest'
        db.delete_table('perms_accessrequest_roles')
    ...
    models = {
        ...
        'perms.accessrequest': {
            ...
            'request_notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'roles': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['perms.Role']", 'null': 'True', 'blank': 'True'}),
            'state': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['workflow.State']", 'null': 'True', 'blank': 'True'}),
