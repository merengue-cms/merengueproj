...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field participants on 'BaseContent'
        db.create_table('base_basecontent_participants', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('basecontent', models.ForeignKey(orm['base.basecontent'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('base_basecontent_participants', ['basecontent_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field participants on 'BaseContent'
        db.delete_table('base_basecontent_participants')
