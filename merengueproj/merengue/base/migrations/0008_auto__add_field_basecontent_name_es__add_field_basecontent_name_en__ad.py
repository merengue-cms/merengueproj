...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BaseContent.no_changeable'
        db.add_column('base_basecontent', 'no_changeable', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'BaseContent.no_deletable'
        db.add_column('base_basecontent', 'no_deletable', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BaseContent.no_changeable'
        db.delete_column('base_basecontent', 'no_changeable')

        # Deleting field 'BaseContent.no_deletable'
        db.delete_column('base_basecontent', 'no_deletable')
