...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BaseContent.meta_desc'
        db.add_column('base_basecontent', 'meta_desc', orm['base.basecontent:meta_desc'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'BaseContent.meta_desc'
        db.delete_column('base_basecontent', 'meta_desc')
        
        # Adding field 'BaseContent.metadesc'
        db.add_column('base_basecontent', 'metadesc', orm['base.basecontent:metadesc'])
