...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseContent.position'
        db.add_column('base_basecontent', 'position', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'BaseContent.position'
        db.delete_column('base_basecontent', 'position')
