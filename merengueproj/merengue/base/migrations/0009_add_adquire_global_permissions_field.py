...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseContent.adquire_global_permissions'
        db.add_column('base_basecontent', 'adquire_global_permissions', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'BaseContent.adquire_global_permissions'
        db.delete_column('base_basecontent', 'adquire_global_permissions')
