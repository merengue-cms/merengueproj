...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseContent.workflow_status'
        db.add_column('base_basecontent', 'workflow_status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workflow.State'], null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'BaseContent.workflow_status'
        db.delete_column('base_basecontent', 'workflow_status_id')
