...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactInfo.name'
        db.add_column('base_contactinfo', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ContactInfo.name'
        db.delete_column('base_contactinfo', 'name')
