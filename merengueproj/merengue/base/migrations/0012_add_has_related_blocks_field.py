...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseContent.has_related_blocks'
        db.add_column('base_basecontent', 'has_related_blocks', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'BaseContent.has_related_blocks'
        db.delete_column('base_basecontent', 'has_related_blocks')
