...
@register.inclusion_tag('base/content_comments.html', takes_context=True)
...
@register.inclusion_tag('base/content_comment.html', takes_context=True)
...
@register.inclusion_tag('base/comments_media.html', takes_context=True)
